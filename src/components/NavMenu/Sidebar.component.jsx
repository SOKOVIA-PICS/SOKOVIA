  ...
  const [nav, setNav] = useState([
    {
      ...
      svg: (
        <svg
          ...
          strokeWidth="1.5"
          stroke="currentColor"
          className="w-6 h-6 stroke-current group-hover:scale-110 duration-75"
        >
          <path
            strokeLinecap="round"
      ...
      activeSvg: (
        <svg
          ...
          viewBox="0 0 24 24"
          fill="currentColor"
          className="w-6 h-6 fill-current group-hover:scale-110 duration-75"
        >
    ...
    },
    {
      ...
      svg: (
        <svg
          ...
          strokeWidth="1.5"
          stroke="currentColor"
          className="w-6 h-6 stroke-curent group-hover:scale-110 duration-75"
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
